...
//NexButton b72 = NexButton(8, , "b38");      //  pressure increment Button
...
NexButton b73 = NexButton(11, , "b73");      //  save alarm configuration
...
NexButton b70 = NexButton(18, , "b70");      //  previous page Button

//Objects window 19//////////////////////////////////////////////
NexDSButton bt1 = NexDSButton(19, , "bt1");  //  silence or not silence sound alarms Button
NexButton b71 = NexButton(19, , "b71");      //  other opt Button
